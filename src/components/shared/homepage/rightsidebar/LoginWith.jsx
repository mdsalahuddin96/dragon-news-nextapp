    ...
    <div>
      ...
      <div className="mt-4 space-y-2 mb-7">
        <button
          ...
          className="cursor-pointer border border-blue-400 flex gap-1 items-center justify-center text-blue-400 p-1 rounded-sm w-full"
        >
          <FaGoogle></FaGoogle> Login With Google
        </button>
        <button onClick={handleGithubLogin} className="cursor-pointer w-full border border-gray-500 flex gap-1 items-center justify-center text-gray-500 p-1 rounded-sm">
